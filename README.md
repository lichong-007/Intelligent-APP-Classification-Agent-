...
Standardized structured output from APK dynamic analysis, aggregating parsed metadata including package name, version, certificates, and country-level attribution for downstream multi-modal classification.
